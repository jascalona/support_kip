        ...
        <div class="container-general-guias">
            ...
            <div class="card mb-3" style="max-width: 500px; max-height: 300px;">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a href="./General_guias/TB-K134G-001+Intro-Tech+Education.pdf"><p class="card-text"><small class="text-body-secondary">Echar un Vistazo</small></p></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 500px; max-height: 300px;">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a href="./General_guias/TB-K134G-002+KIP+System+K+Software+Ver+3.1.pdf"><p class="card-text"><small class="text-body-secondary">Echar un Vistazo</small></p></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 500px; max-height: 300px;">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a href="./General_guias/TB-K134G-006+Product+Enhancement+-+Touchscreen.pdf"><p class="card-text"><small class="text-body-secondary">Echar un Vistazo</small></p></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 500px; max-height: 300px;">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a href="./General_guias/TB-K134G-008a+Touch+panel+Random+no+touch+response.pdf"><p class="card-text"><small class="text-body-secondary">Echar un Vistazo</small></p></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card mb-3" style="max-width: 500px; max-height: 300px;">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a href="./General_guias/TB-K134G-004+Printer+Firmware+FWU-04.pdf"><p class="card-text"><small class="text-body-secondary">Echar un Vistazo</small></p></a>
                    </div>
                </div>
                </div>
            </div>
